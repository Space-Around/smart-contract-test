 ...
 */
const { alchemyApiKey, mnemonic, accountPrivateKey } = require('./secrets.json');
...
task("mint", "Mints from the NFTMint5 contract")
.addParam("address", "The address to receive a token")
.setAction(async function (taskArguments, hre) {
    const contract = await getContract("NFTMint5", hre);
